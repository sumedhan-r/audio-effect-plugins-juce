...
//==============================================================================
_01_Learn_DelayAudioProcessorEditor::_01_Learn_DelayAudioProcessorEditor (_01_Learn_DelayAudioProcessor& p)
...
void _01_Learn_DelayAudioProcessorEditor::paint (juce::Graphics& g)
{
    ...
    g.drawFittedText ("My first plug-in", getLocalBounds(), juce::Justification::centred, 1);   // change_3
}
