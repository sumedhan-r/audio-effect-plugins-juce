...
int _01_Learn_DelayAudioProcessor::getCurrentProgram()
{
    return 0;
}
...
void _01_Learn_DelayAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}

//==============================================================================
void _01_Learn_DelayAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool _01_Learn_DelayAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void _01_Learn_DelayAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
//==============================================================================
void _01_Learn_DelayAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void _01_Learn_DelayAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
